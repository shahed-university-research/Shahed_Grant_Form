...
function update() {
  ...
  if (d3.select("#state").property("value") == 1) {
    ...
    code1 = '#NUM#,' + d3.select('#meli').property("value") + ',' + d3.select('#email').property("value") + ',' + d3.select("#state").property("value") + ',' + percent + ',' + research_score + ',' + personnel_grant_state1.toFixed(3) + ',' + non_personnel_grant_state1.toFixed(3) + ',' + total_grant_state1.toFixed(3) + ',#NUM#'
    ...
    qrcode_text = d3.select('#meli').property("value") + ',' + d3.select('#email').property("value") + ',' + d3.select("#state").property("value") + ',' + percent + ',' + research_score + ',' + personnel_grant_state1.toFixed(3) + ',' + non_personnel_grant_state1.toFixed(3) + ',' + total_grant_state1.toFixed(3) + ',' + d3.select('#name1').property("value") + ',' + d3.select('#name2').property("value") + ',' + d3.select('#faculty').property("value") + ',' + d3.select('#group').property("value")
  }
  ...
  if (d3.select("#state").property("value") == 2) {
    ...
    d3.select('#group_output').text(d3.select('#group').property("value"))
    // code1 = '#NUM#,' +F2F.simplef2f(d3.select('#name1').property("value")) + ',' + F2F.simplef2f(d3.select('#name2').property("value")) + ',' + F2F.simplef2f(d3.select('#faculty').property("value")) + ',' + F2F.simplef2f(d3.select('#group').property("value"))+ ',' +d3.select('#meli').property("value") + ',' + d3.select('#email').property("value") + ',' + d3.select("#state").property("value") + ',' + percent + ',' + research_score + ',' + personnel_grant_state3.toFixed(3) + ',' + non_personnel_grant_state3.toFixed(3) + ',' + total_grant_state3.toFixed(3)+ ',#NUM#'
    code1 = '#NUM#,' + d3.select('#meli').property("value") + ',' + d3.select('#email').property("value") + ',' + d3.select("#state").property("value") + ',' + percent + ',' + research_score + ',' + personnel_grant_state2.toFixed(3) + ',' + non_personnel_grant_state2.toFixed(3) + ',' + total_grant_state2.toFixed(3) + ',#NUM#'
    code2 = '#NAM#,' + d3.select('#name1').property("value") + ',' + d3.select('#name2').property("value") + ',' + d3.select('#faculty').property("value") + ',' + d3.select('#group').property("value") + ',#NAM#'
    qrcode_text = d3.select('#meli').property("value") + ',' + d3.select('#email').property("value") + ',' + d3.select("#state").property("value") + ',' + percent + ',' + research_score + ',' + personnel_grant_state2.toFixed(3) + ',' + non_personnel_grant_state2.toFixed(3) + ',' + total_grant_state2.toFixed(3) + ',' + d3.select('#name1').property("value") + ',' + d3.select('#name2').property("value") + ',' + d3.select('#faculty').property("value") + ',' + d3.select('#group').property("value")
